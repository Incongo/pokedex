...
async function cargarPokemon() {
  ...
  try {
    ...
    const colorMapa = {
      electric: { bg: "rgba(255,235,59,0.25)", border: "rgba(255,235,59,1)", point: "rgba(255,193,7,1)" },
      fire: { bg: "rgba(244,67,54,0.25)", border: "rgba(244,67,54,1)", point: "rgba(183,28,28,1)" },
      water: { bg: "rgba(33,150,243,0.25)", border: "rgba(33,150,243,1)", point: "rgba(13,71,161,1)" },
      grass: { bg: "rgba(76,175,80,0.25)", border: "rgba(76,175,80,1)", point: "rgba(27,94,32,1)" },
      psychic: { bg: "rgba(233,30,99,0.25)", border: "rgba(233,30,99,1)", point: "rgba(136,14,79,1)" },
      rock: { bg: "rgba(141,110,99,0.25)", border: "rgba(141,110,99,1)", point: "rgba(78,52,46,1)" },
      ground: { bg: "rgba(161,136,127,0.25)", border: "rgba(161,136,127,1)", point: "rgba(93,64,55,1)" },
      ice: { bg: "rgba(0,188,212,0.25)", border: "rgba(0,188,212,1)", point: "rgba(0,96,100,1)" },
      dragon: { bg: "rgba(103,58,183,0.25)", border: "rgba(103,58,183,1)", point: "rgba(49,27,146,1)" },
      dark: { bg: "rgba(33,33,33,0.25)", border: "rgba(33,33,33,1)", point: "rgba(0,0,0,1)" },
      fairy: { bg: "rgba(248,187,208,0.35)", border: "rgba(240,98,146,1)", point: "rgba(194,24,91,1)" },
      normal: { bg: "rgba(207,216,220,0.35)", border: "rgba(120,144,156,1)", point: "rgba(69,90,100,1)" },
      fighting: { bg: "rgba(211,47,47,0.25)", border: "rgba(211,47,47,1)", point: "rgba(127,0,0,1)" },
      poison: { bg: "rgba(156,39,176,0.25)", border: "rgba(156,39,176,1)", point: "rgba(74,20,140,1)" },
      bug: { bg: "rgba(139,195,74,0.25)", border: "rgba(139,195,74,1)", point: "rgba(85,139,47,1)" },
      ghost: { bg: "rgba(96,125,139,0.25)", border: "rgba(96,125,139,1)", point: "rgba(38,50,56,1)" },
    };
